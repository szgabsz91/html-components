...
@CustomTag('datagrid-page')
class DatagridPage extends PolymerElement {
  ...
  DatagridPage.created() : super.created();
  
  @override
  void enteredView() {
    super.enteredView();
    
    this.shadowRoot.querySelectorAll('h-datagrid').forEach((DatagridComponent datagrid) {
      datagrid.on['selected'].listen((CustomEvent event) {
