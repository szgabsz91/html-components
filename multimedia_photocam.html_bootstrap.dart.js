...
$is_HB:true,
$is_Dv:true}]
;init.mangledNames={gB:"length",gCr:"_mangledName",gDb:"_cachedDeclarations",gFU:"_cachedMethodsMap",gH8:"_fieldsDescriptor",gHt:"_fieldsMetadata",gIL:"_stream",gKM:"$",gLy:"_cachedSetters",gM2:"_cachedVariables",gOk:"_cachedMetadata",gP:"value",gR:"width",gT1:"_cachedGetters",gTx:"_jsConstructorOrInterceptor",gUF:"_cachedTypeVariables",ga:"a",gb:"b",gb0:"_cachedConstructors",gcC:"hash",gfg:"height",gjd:"_cachedMethods",glB:"audio",gle:"_metadata",gnz:"_owner",gpz:"_jsConstructorCache",gqN:"_superclass",gqm:"_cachedSuperinterfaces",gtB:"_cachedFields",guA:"_cachedMembers",gvH:"index",gvT:"started",gxc:"effect"};(function (reflectionData) {
...
$isGv:true,
"%":"CanvasRenderingContext|CanvasRenderingContext2D|DOMImplementation|MediaError|MediaKeyError|SVGAnimatedEnumeration|SVGAnimatedLength|SVGAnimatedNumberList|SVGAnimatedString"},kn:{"":"bool/Gv;",
...
$isOd:true}}],["app_bootstrap","file:///D:/workspace/dart/html_components_app_polymer/web/multimedia_photocam.html_bootstrap.dart",,E,{E2:function(){$.x2=["package:html_components/multimedia/photocam.dart","multimedia_photocam.dart"]
$.uP=!1
...
"+toString:0:0":0,
$isa6:true,
static:{"":"Bp,S4,dk,Lo,zj,b2,q9,Ie,Do,f4,vd,IJ,V6,Vk,fm,yn",k5:function(a,b,c,d,e,f){return new P.a6(a*86400000000+b*3600000000+e*60000000+f*1000000+d*1000+c)}}},P7:{"":"Tp;",
call$1:function(a){var z=J.Wx(a)
...
z.PD(a)
return z}}},wv:{"":"a;",$iswv:true},uq:{"":"a;",$isuq:true},iD:{"":"a;NN,HC,r0,Fi,iV,tP,BJ,MS,Op",
...
this.r0=this.x6(c,d)},
$isiD:true,
static:{"":"Um,B4,Bx,iR,LM,iI,nR,jJ,d2,q7,ux,vI,il,tC,IL,Q5,zk,om,qD,O5,eq,qf,Tx,y3,Cn,R1,YD,vT,K7,nL,H5,zst,eK,bf,Sp,nU,uj,SQ,SD",r6:function(a){var z,y,x,w,v,u,t,s
z=a.oH
if(1>=z.length)throw H.e(z,1)
y=z[1]
y=P.iy(y!=null?y:"")
...
"+toString:0:0":0,
"%":"HTMLAnchorElement"},fY:{"":"qE;cC:hash=,LU:href=,N:target=","%":"HTMLAreaElement"},nB:{"":"qE;LU:href=,N:target=","%":"HTMLBaseElement"},Az:{"":"Gv;r9:type=",$isAz:true,"%":";Blob"},QW:{"":"qE;MB:form=,oc:name=,r9:type%,P:value%","%":"HTMLButtonElement"},Ny:{"":"qE;fg:height%,R:width%",
gVE:function(a){return a.getContext("2d")},
Rb:function(a,b,c){return a.toDataURL(b,c)},
yW:function(a,b){return this.Rb(a,b,null)},
"%":"HTMLCanvasElement"},OM:{"":"KV;B:length=",$isGv:true,"%":"Comment;CharacterData"},oJ:{"":"BV;B:length=",
...
pr:function(a,b){return W.vD(a.querySelectorAll(b),null)},
$isGv:true,
"%":";DocumentFragment"},Wq:{"":"KV;",$isGv:true,"%":"DocumentType"},rv:{"":"Gv;G1:message=,oc:name=","%":"DOMError|FileError"},Nh:{"":"Gv;G1:message=",
...
$iscv:true,
$isGv:true,
"%":";Element"},Fs:{"":"qE;fg:height%,oc:name=,LA:src%,r9:type%,R:width%","%":"HTMLEmbedElement"},ZM:{"":"ea;kc:error=,G1:message=","%":"ErrorEvent"},ea:{"":"Gv;It:_selector},Xt:bubbles=,Ii:path=,r9:type=",
...
$isD0:true,
"%":";EventTarget"},as:{"":"qE;MB:form=,oc:name=,r9:type=","%":"HTMLFieldSetElement"},RI:{"":"Az;oc:name=",$isRI:true,"%":"File"},Yu:{"":"qE;B:length=,bP:method=,oc:name=,N:target=","%":"HTMLFormElement"},xn:{"":"ec;",
gB:function(a){return a.length},
"+length":0,
...
"%":"XMLHttpRequest"},Vi:{"":"D0;","%":";XMLHttpRequestEventTarget"},tX:{"":"qE;fg:height%,oc:name=,LA:src%,R:width%","%":"HTMLIFrameElement"},Sg:{"":"Gv;fg:height=,R:width=",$isSg:true,"%":"ImageData"},pA:{"":"qE;fg:height%,LA:src%,R:width%",
...
"%":"HTMLAudioElement;HTMLMediaElement"},aB:{"":"ea;G1:message=","%":"MediaKeyEvent"},ku:{"":"ea;G1:message=","%":"MediaKeyMessageEvent"},tA:{"":"D0;jO:id=",
...
"%":"MutationObserver|WebKitMutationObserver"},It:{"":"Gv;jL:oldValue=,N:target=,r9:type=","%":"MutationRecord"},oU:{"":"Gv;",
...
this.vS(a)
this.aY(a,P.bL(x),new W.Lx(y),new W.Qe(y))
return y.MM},
...
$isGv:true,
"%":"Navigator"},ih:{"":"Gv;G1:message=,oc:name=","%":"NavigatorUserMediaError"},KV:{"":"D0;q6:firstChild=,uD:nextSibling=,M0:ownerDocument=,eT:parentElement=,KV:parentNode=,a4:textContent}",
...
$asWO:function(){return[W.KV]},
$ascX:function(){return[W.KV]}},nj:{"":"Gv+lD;",$isList:true,$asWO:null,$isqC:true,$iscX:true,$ascX:null},rl:{"":"nj+Gm;",$asWO:null,$ascX:null,$isList:true,$isqC:true,$iscX:true},qb:{"":"Gv+lD;",$isList:true,$asWO:null,$isqC:true,$iscX:true,$ascX:null},Gb:{"":"qb+Gm;",$asWO:null,$ascX:null,$isList:true,$isqC:true,$iscX:true},cf:{"":"a;",
PF:function(a){var z
...
"+toString:0:0":0,
$iscS:true,
$isGv:true}}],["dart.dom.indexed_db","dart:indexed_db",,P,{hF:{"":"Gv;",$ishF:true,"%":"IDBKeyRange"}}],["dart.dom.svg","dart:svg",,P,{Y0:{"":"tp;N:target=,LU:href=",$isGv:true,"%":"SVGAElement"},ZJ:{"":"Eo;LU:href=",$isGv:true,"%":"SVGAltGlyphElement"},ui:{"":"MB;",$isGv:true,"%":"SVGAnimateColorElement|SVGAnimateElement|SVGAnimateMotionElement|SVGAnimateTransformElement|SVGAnimationElement|SVGSetElement"},D6:{"":"tp;",$isGv:true,"%":"SVGCircleElement"},DQ:{"":"tp;",$isGv:true,"%":"SVGClipPathElement"},Sm:{"":"tp;",$isGv:true,"%":"SVGDefsElement"},es:{"":"tp;",$isGv:true,"%":"SVGEllipseElement"},eG:{"":"MB;fg:height=,R:width=",$isGv:true,"%":"SVGFEBlendElement"},lv:{"":"MB;r9:type=,UQ:values=,fg:height=,R:width=",$isGv:true,"%":"SVGFEColorMatrixElement"},pf:{"":"MB;fg:height=,R:width=",$isGv:true,"%":"SVGFEComponentTransferElement"},NV:{"":"MB;kp:operator=,fg:height=,R:width=",$isGv:true,"%":"SVGFECompositeElement"},W1:{"":"MB;fg:height=,R:width=",$isGv:true,"%":"SVGFEConvolveMatrixElement"},zo:{"":"MB;fg:height=,R:width=",$isGv:true,"%":"SVGFEDiffuseLightingElement"},wf:{"":"MB;fg:height=,R:width=",$isGv:true,"%":"SVGFEDisplacementMapElement"},bb:{"":"MB;fg:height=,R:width=",$isGv:true,"%":"SVGFEFloodElement"},G0:{"":"MB;fg:height=,R:width=",$isGv:true,"%":"SVGFEGaussianBlurElement"},me:{"":"MB;fg:height=,R:width=,LU:href=",$isGv:true,"%":"SVGFEImageElement"},qN:{"":"MB;fg:height=,R:width=",$isGv:true,"%":"SVGFEMergeElement"},d4:{"":"MB;kp:operator=,fg:height=,R:width=",$isGv:true,"%":"SVGFEMorphologyElement"},MI:{"":"MB;fg:height=,R:width=",$isGv:true,"%":"SVGFEOffsetElement"},kK:{"":"MB;fg:height=,R:width=",$isGv:true,"%":"SVGFESpecularLightingElement"},um:{"":"MB;fg:height=,R:width=",$isGv:true,"%":"SVGFETileElement"},Fu:{"":"MB;r9:type=,fg:height=,R:width=",$isGv:true,"%":"SVGFETurbulenceElement"},OE:{"":"MB;fg:height=,R:width=,LU:href=",$isGv:true,"%":"SVGFilterElement"},l6:{"":"tp;fg:height=,R:width=",$isGv:true,"%":"SVGForeignObjectElement"},BA:{"":"tp;",$isGv:true,"%":"SVGGElement"},tp:{"":"MB;",$isGv:true,"%":";SVGGraphicsElement"},rE:{"":"tp;fg:height=,R:width=,LU:href=",$isGv:true,"%":"SVGImageElement"},Vq:{"":"tp;",$isGv:true,"%":"SVGLineElement"},uz:{"":"MB;",$isGv:true,"%":"SVGMarkerElement"},Yd:{"":"MB;fg:height=,R:width=",$isGv:true,"%":"SVGMaskElement"},AD:{"":"tp;",$isGv:true,"%":"SVGPathElement"},Gr:{"":"MB;fg:height=,R:width=,LU:href=",$isGv:true,"%":"SVGPatternElement"},tc:{"":"tp;",$isGv:true,"%":"SVGPolygonElement"},GH:{"":"tp;",$isGv:true,"%":"SVGPolylineElement"},NJ:{"":"tp;fg:height=,R:width=",$isGv:true,"%":"SVGRectElement"},nd:{"":"MB;r9:type%,LU:href=",$isGv:true,"%":"SVGScriptElement"},EU:{"":"MB;r9:type%","%":"SVGStyleElement"},MB:{"":"cv;",
...
$ascX:function(){return[J.im]},
$isXj:true,
static:{"":"U9",}}}],["html_common","dart:html_common",,P,{jD:function(a){return P.Wu(a.getTime(),!0)},bL:function(a){var z,y
z=[]
...
$isEH:true,
$is_HB:true,
$is_Dv:true}}],["logging","package:logging/logging.dart",,N,{TJ:{"":"a;oc>,eT>,yz,Cj>,wd>,Gs",
...
"+toString:0:0":0,
$isNg:true,
static:{"":"h1,tm,pR,X8,IQ,Pk,Eb,BC,BZ,bo,B9",}},HV:{"":"a;OR<,G1>,iJ,Fl,O0,kc>,I4<",
...
z.$builtinTypeInfo=[null,null]
this.SZ(this,z)}"15,43,54,13,53,48"},
"+[]=:2:0":1,
...
return z.vM},
"+toString:0:0":0}}],["","package:html_components/multimedia/photocam.dart",,F,{Sa:{"":["ir;R%-,fg%-,lB%-,xc%-,vT%-,IL%-,VJ,Ai,ZI,uN,z3,TQ,Vk,Ye,mT,KM-",function(){return[C.Us]},function(){return[C.Us]},function(){return[C.Us]},function(){return[C.Us]},function(){return[C.J1]},null,null,null,null,null,null,null,null,null,null,function(){return[C.B10]}],
wE:function(a){J.k2(window.navigator,a.lB,!0).ml(new F.CV(a))
"15"},
"+start:0:0":1,
...
C.PF.FH(a)
return a
"9"},"+new PhotocamComponent$created:0:0":1}},"+PhotocamComponent": [60],CV:{"":"Tp;a-",
call$1:function(a){var z,y
z=this.a
y=J.RE(z)
y.sIL(z,a)
J.Yj(J.UQ(y.gKM(z),"video"),(self.URL||self.webkitURL).createObjectURL(a))
P.rT(C.tk,new F.n9(z))
y.svT(z,!0)
"15,61,62"},
"+call:1:0":1,
$isEH:true,
$is_HB:true,
$is_Dv:true},"+PhotocamComponent_start_closure": [45],n9:{"":"Tp;b-",
call$0:function(){var z,y,x,w
z=this.b
y=J.RE(z)
...
"+call:0:0":1,
$isEH:true,
$is_X0:true},"+PhotocamComponent_start__closure": [45]}],["polymer","package:polymer/polymer.dart",,A,{JX:function(){var z,y
...
C.GB.ZL(a)
C.GB.FH(a)
return a},"+new PolymerElement$created:0:0":0}},jp:{"":["qE+dM;KM=-",function(){return[C.B10]}],$isdM:true,$ishs:true,$iswn:true,$iscv:true,$isGv:true,$isKV:true,$isD0:true},Tt:{"":"jp+Pi;",$iswn:true},k8:{"":"a;jL>,zZ*",$isk8:true},HJ:{"":"e9;nF"},S0:{"":"a;Ow,VC",
...
$.IS().A3("Error evaluating expression '"+H.d(this.jf)+"': "+J.z2(z))}else throw y}"15,63,15,48"},
"+value=":1,
...
C.NU=new P.R8()
C.v8=new P.AH()
C.iE=new A.V3("h-photocam")
C.RT=new P.a6(0)
C.tk=new P.a6(100000)
...
C.vO=H.Kx('br')
C.wK=new H.Jk(C.vO,"K",0)
C.SL=H.Kx('Ae')
C.WX=new H.Jk(C.SL,"V",0)
C.QJ=H.Kx('xh')
C.wW=new H.Jk(C.QJ,"T",0)
C.wa=new H.Jk(C.vO,"V",0)
C.nY=H.Kx('a')
C.Yc=H.Kx('iP')
C.xS=H.Kx('UZ')
C.Op=H.Kx('G8')
...
J.k2=function(a,b,c){return J.RE(a).Fg(a,b,c)}
