import 'package:html_components/html_components.dart' show TreeNode, StringTreeNode;
...
abstract class TreeNodeConverter {
  
  String treeNodeToString(var treeNode) {
    if (treeNode is Map) {
      return treeNode['name'];
    }
    else if (treeNode is Document) {
      return treeNode.name;
    }
