...
"+call:2:0":0,
$isEH:true,
$is_bh:true}}],["","package:html_components/utility/clock.dart",,E,{tg:{"":["Xf;zm%-,VJ,Ai,VJ,Ai,ZI,uN,Wh,TQ,Vk,Ye,mT,KM-",null,null,null,null,null,null,null,null,null,null,null,null,function(){return[C.nJ]}],
...
init.globalFunctions.lS=O.lS=new H.HB(O.E2,"lS")
J.O.$isString=true
J.O.$isfR=true
J.O.$asfR=[J.O]
J.O.$isa=true
...
;(function (callback) {
  ...
  if (typeof dartMainRunner === "function") {
    dartMainRunner(function() { H.Vg(O.lS); });
  } else {
    H.Vg(O.lS);
  }
})
